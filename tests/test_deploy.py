...
def test_release_docs_and_examples_describe_one_atomic_v57_layout():
    deploy_readme = (ROOT / "deploy" / "README.md").read_text()
    ...
    assert "Protocol v57" in deploy_readme
