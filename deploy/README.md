...
Protocol v72 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v72 relay/web release; then start the v72 wrapper.
...
verify v72, and retain that snapshot with the previous release. To roll back,
stop v72, run `work_registry_snapshot.py restore`, then switch and start the old
...
Protocol v72 carries explicit DSH continuation markers in live bindings and
