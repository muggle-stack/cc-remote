...
Protocol v59 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v59 relay/web release; then start the v59 wrapper.
...
verify v59, and retain that snapshot with the previous release. To roll back,
stop v59, run `work_registry_snapshot.py restore`, then switch and start the old
