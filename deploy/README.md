...
Protocol v62 is a coordinated upgrade: publish freshly built Relay/Web and
...
activate the v62 relay/web release; then start the v62 wrapper.
...
verify v62, and retain that snapshot with the previous release. To roll back,
stop v62, run `work_registry_snapshot.py restore`, then switch and start the old
